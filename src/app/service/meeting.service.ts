...
export class MeetingService {
  ...
  validateMeeting(id:any,decision:any): Observable<Meeting> {
    return this.http.put<Meeting>(
      this.baseUrl + '/validatemeeting/'+id+"/"+decision,
      ""
    );
  }
  ...
  getmeetingbypartner(id:any): Observable<Meeting[]>{
    return this.http.get<Meeting[]>(this.baseUrl+'/getmeetingbypartner/'+id)
  }
